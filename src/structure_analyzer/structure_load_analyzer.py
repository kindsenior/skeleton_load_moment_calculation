...
if __name__ == '__main__':
    ...
    analyzer = JointLoadWrenchAnalyzer([0,0,(0,0),0,0,0], end_link_name="JOINT5", robot_model_file=os.path.join(model_path,"universal-joint-robot_"+joint_structure_str+".wrl"))
