...
do
    ...
    convert $pose -crop "150x360+500+500" -quality 10 -resize 200% $pose_cut
done

crop_region="450x450+400+550"
...
do
    ...
    convert $pose0 -crop $crop_region -quality 10 -resize 200% $pose0_cut
    ...
    convert $pose1 -crop $crop_region -quality 10 -resize 200% $pose1_cut
...
for idx in $(seq 0 1)
do
    ffmpeg -y -framerate 5 -i $package_dir/joint-configuration-comparison/joint-configuration-comparison_configuration${idx}_%02d.png -vcodec libx264 -pix_fmt yuv420p -r 30 $package_dir/joint-configuration-comparison/joint-configuration-comparison_configuration${idx}.mp4
done
