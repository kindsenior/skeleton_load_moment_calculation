...
do
    ...
    convert $pose2 -crop $crop_region -quality 10 -resize 200% $pose2_cut
...
for idx in $(seq 0 2)
do
    ffmpeg -y -framerate 5 -i $package_dir/drive-system-comparison/drive-system-comparison_system${idx}_%02d.png -vcodec libx264 -pix_fmt yuv420p -r 30 $package_dir/drive-system-comparison/drive-system-comparison_system${idx}.mp4
done
